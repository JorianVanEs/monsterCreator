...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function togglePopup() {
            ...
            if (this.popupActive) {
                this.setState({
                    popupHTML: _react2.default.createElement(
                        'div',
                        { id: 'popup' },
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_header2.default, { pop: function pop() {
                        return _this3.togglePopup();
                    } }),
                _react2.default.createElement(
                    'div',
                    { id: 'page' },
...
var Aside = function (_React$Component) {
    ...
    function Aside() {
        ...
        return _possibleConstructorReturn(this, (Aside.__proto__ || Object.getPrototypeOf(Aside)).call(this));
    }
...
var Register = function (_Component) {
    ...
    _createClass(Register, [{
        key: 'checkDetails',
        value: function checkDetails() {
            var _this2 = this;

            var errorArray = [];
            fetch("https://jorianvan.es/dungeonmuster/assets/src/api/registered_users.php").then(function (res) {
                return res.json();
            }).then(function (res) {
                if (_this2.email !== '') {
                    if (_this2.email.includes("@") && _this2.email.includes(".")) {
                        res.forEach(function (item) {
                            if (item.user_email != _this2.email) {
                                _this2.emailValid = true;
                            } else {
                                _this2.emailValid = false;
                ...
                if (_this2.username !== '') {
                    res.forEach(function (item) {
                        if (item.user_name != _this2.username) {
                            _this2.usernameValid = true;
                        } else {
                            _this2.usernameValid = false;
                        }
                    });
                } else {
                ...
                if (_this2.password !== '') {
                    if (_this2.hasUpperCase(_this2.password) && _this2.hasNumber(_this2.password) && _this2.hasSpecialCharacters(_this2.password)) {
                        if (_this2.password === _this2.confirmedPassword) {
                            _this2.passwordValid = true;
                        } else {
                            _this2.passwordValid = false;
                ...
                if (_this2.emailValid && _this2.usernameValid && _this2.passwordValid) {
                    _this2.registerUser();
                    _this2.setState({
                        errors: ""
        ...
        key: 'hasUpperCase',
        value: function hasUpperCase(string) {
            var character = '';
        ...
        value: function hasSpecialCharacters(string) {
        ...
        value: function registerUser() {
            var url = new URL('https://jorianvan.es/dungeonmuster/assets/src/api/register_user.php');
            var params = {
                email: "1",
                name: "2",
                password: "3"
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'text', onChange: function onChange(event) {
                        _this3.username = event.target.value;
                    } }),
                _react2.default.createElement(
                    'label',
                    null,
                ...
                _react2.default.createElement('input', { type: 'password', onChange: function onChange(event) {
                        _this3.password = event.target.value;
                    } }),
                _react2.default.createElement(
                    'label',
                    null,
                ...
                _react2.default.createElement('input', { type: 'password', id: 'confirmedPassword', onChange: function onChange(event) {
                        _this3.confirmedPassword = event.target.value;
                    } }),
                this.state.errors,
                _react2.default.createElement(
                    'button',
